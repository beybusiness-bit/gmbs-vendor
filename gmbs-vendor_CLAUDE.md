...
4단계 — 브랜드 정보 조회/수정(브랜드회원) 구현. 앱 골격(1~3단계)은 완료됨.
- Firebase config: beyhome-admin 프로젝트 (apiKey: AIzaSyC8uy09XOeEYIs1m3Rga5BMqd7gS7o3roI)
- 파일 구조: index.html / style.css / app.js / firebase-init.js (ES Module, CDN)
